...
namespace TP2.Vue
{
    public partial class PkmEnemy : UserControl, IObservateur<Pokemon>
    {
        ...
        public void SetPokemon(Pokemon enemy)
        {
            if (ThisPokemon != null)
            {
                ThisPokemon.RemoveObserver(this);
            }
            this.ThisPokemon = enemy;
        ...
        private void SetDefaults()
        {
            ...
            Bitmap frontPicture = PokemonPictures.GetFrontPicture(ThisPokemon.PokedexNumber);
